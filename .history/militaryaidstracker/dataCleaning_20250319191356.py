...
df = aid_df[['activity_id', 'announcement_date', 'donor', 'item_value_estimate_USD',
                        'explanation', 'reporting_currency', 'source_reported_value', 'measure']].copy() # , 'classified_category'
