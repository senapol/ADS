...
aid_main_df = aid_df['Filtered Data'].head(100).copy()
...
df = aid_main_df[['announcement_date', 'donor', 'aid_type_general', 'aid_type_specific', 'tot_activity_value_EUR',
...
df["tot_activity_value_EUR"] = df.apply(
