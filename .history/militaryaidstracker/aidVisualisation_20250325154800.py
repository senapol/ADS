...
plt.plot(df['announcement_date'], df["Portable defence system"], 
            marker='o', 
            label="Portable Defence System",
            linewidth=2,
            markersize=8)
...
plt.title('Monthly Portable Defence System Aid Over Time')
...
plt.yscale('symlog')
plt.ylim(-10**1, 10**12)
plt.ylabel('Aid Amount (log scale)')

# Adjust layout to prevent label cutoff
plt.tight_layout()

# Save the figure as a PNG file with a dpi of 300
plt.savefig("portable_defence_monthly_graph.png", dpi=300)
