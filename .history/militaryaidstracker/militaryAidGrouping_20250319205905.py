...
df = aid_df[['activity_id', 'announcement_date', 'donor', 'item_type', 'item_value_estimate_USD', 'item_value_estimate_USD', 'explanation', 
...
dict_weapons = {'.' : None, 'Ammunition for portable defence system' : 'Portable defence system', 'Ammunition for heavy weapon' : 'Heavy weapon',
 ...
 'Heavy Weapon' : 'Heavy weapon', 'ammunition for heavy weapon' : 'Heavy weapon', 'Missile' : 'Heavy weapon', 'Funding, training, services' : 'Military equipment'} # , 'Ammunition'
...
print(df[(df['item_type'] == 'Ammunition') | (df['item_type'] == 'Funding, training, services') | (df['item_type'] == 'Missile')])
