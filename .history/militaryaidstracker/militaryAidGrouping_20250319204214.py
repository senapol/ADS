...
dict_weapons = {'.' : None, 'Humanitarian' 'Military equipment' 'Aviation and drones'
 ...
 'humanitarian' 'Ammunition for Heavy Weapon'
 'Funding, training, services' 'Missile' 'military equipment'
 'Military equipment ' 'Military Equipment' 'Aviation and Drones'
 'Heavy Weapon' 'ammunition for heavy weapon'}
