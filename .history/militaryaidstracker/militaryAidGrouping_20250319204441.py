...
dict_weapons = {'.' : None, 'Humanitarian' 'Military equipment' 'Aviation and drones'
 'Portable defence system' 'Heavy weapon'
 'Ammunition for portable defence system' : 'Portable defence system', 'Ammunition for heavy weapon' : 'Heavy weapon',
 'Ammunition for light infantry' : 'Light armaments & infantry', 'Ammunition'
 'humanitarian' : 'Humanitarian', 'Ammunition for Heavy Weapon' : 'Heavy weapon'
 'Funding, training, services' 'Missile' 'military equipment' : 'Military equipment',
 'Military equipment ':'Military equipment', 'Military Equipment' 'Aviation and Drones'
 'Heavy Weapon' : 'Heavy weapon', 'ammunition for heavy weapon' : 'Heavy weapon'}
